...
local function applyDefaults()
    ...
    setGunModConfig("reload_speed_value", 1); setGunModConfig("zoom_override_enabled", false); setGunModConfig("zoom_override", 1); setGunModConfig("ads_time_ms", 0)
...
local function buildNeverloseUi()
    ...
    local GunMods = RageTab:AddSection({ Name = "GUN MODS", Position = 'right' })
    ...
    GunMods:AddLabel("Gun Mod"):AddToggle({ Default = false, Callback = setGunModEnabled, Flag = "gm_enabled" })
    GunMods:AddLabel("Recoil Reduction"):AddSlider({ Min = 0, Max = 100, Default = 0, Type = "%", Size = 95, Callback = function(v) setGunModConfig("recoil_reduction", v / 100) end, Flag = "gm_recoil" })
    GunMods:AddLabel("Horizontal Recoil"):AddSlider({ Min = 0, Max = 100, Default = 0, Type = "%", Size = 95, Callback = function(v) setGunModConfig("horizontal_recoil", v / 100) end, Flag = "gm_hrecoil" })
    GunMods:AddLabel("No Spread"):AddToggle({ Default = false, Callback = function(v) setGunModConfig("no_spread", v) end, Flag = "gm_spread" })
    GunMods:AddLabel("Force Automatic"):AddToggle({ Default = false, Callback = function(v) setGunModConfig("force_auto", v) end, Flag = "gm_auto" })
    GunMods:AddLabel("Fire Rate"):AddSlider({ Min = 1, Max = 10, Default = 1, Type = "x", Size = 95, Callback = function(v) setGunModConfig("fire_rate_multiplier", v) end, Flag = "gm_firerate" })
    GunMods:AddLabel("Reload Speed"):AddSlider({ Min = 0, Max = 100, Default = 100, Type = "%", Size = 95, Callback = function(v) setGunModConfig("reload_speed_value", v / 100) end, Flag = "gm_reload" })
    GunMods:AddLabel("Custom Zoom"):AddToggle({ Default = false, Callback = function(v) setGunModConfig("zoom_override_enabled", v) end, Flag = "gm_zoom_on" })
    GunMods:AddLabel("Zoom Override"):AddSlider({ Min = 1, Max = 10, Default = 1, Type = "x", Size = 95, Callback = function(v) setGunModConfig("zoom_override", v) end, Flag = "gm_zoom" })
    GunMods:AddLabel("Aim Time"):AddSlider({ Min = 0, Max = 500, Default = 0, Type = "ms", Size = 95, Callback = function(v) setGunModConfig("ads_time_ms", v) end, Flag = "gm_ads" })
