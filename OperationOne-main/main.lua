...
local function applyDefaults()
    ...
    setGunModConfig("reload_speed_multiplier", 1); setGunModConfig("zoom_override", 0); setGunModConfig("ads_time_ms", 0)
...
local function buildNeverloseUi()
    ...
    GunMods:AddLabel("Reload Speed"):AddSlider({ Min = 1, Max = 5, Default = 1, Type = "x", Size = 95, Callback = function(v) setGunModConfig("reload_speed_multiplier", v) end, Flag = "gm_reload" })
    GunMods:AddLabel("Zoom Override"):AddSlider({ Min = 0, Max = 10, Default = 0, Type = "x", Size = 95, Callback = function(v) setGunModConfig("zoom_override", v) end, Flag = "gm_zoom" })
